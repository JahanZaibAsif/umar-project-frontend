...
function Buy_Now({ item }) {
  ...
  const handleConfirmOrder = () => {
    if (!formData.user_name.trim() || !formData.user_phoneNumber.trim() || !formData.size.trim() || !formData.color.trim() || !formData.user_city.trim() || !formData.user_address.trim()) {
          alert("Please fill in the all required fields.");
          return;
      }
    ...
    .then(data => {
      ...
      // const modalTrigger = document.getElementById('confirm_order');
      // modalTrigger.click();
       })
    .catch(error => {
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                <div className="row mt-4">
                  ...
                  <div className="col-sm-6">
                    <select name="size" value={formData.size} onChange={handleInputChange} className='form-select' title="Available Size only number Exist" id="">
                  ...
                  <div className="col-sm-6">
                    <select name="color" value={formData.color} onChange={handleInputChange} className='form-select' id="">
